...
<div class="index">
    <main class="edit">
        <h1 class="form-signin-heading">Добавление отзыва</h1>
        <form:form method="POST" modelAttribute="feedback">
                ...
                <form method="post" action="${pageContext.request.contextPath}/feedback/add/${barber_id}">
                    <button class="formcource" type="submit" name="${_csrf.parameterName}" value="${_csrf.token}">Оставить отзыв</button>
                </form>
            </form:form>
