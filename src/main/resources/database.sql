...
insert into User(username, password) values ('admin', '$2a$11$4wXmhyZHOM8MJamwV6yVAeF5a2Q'),('aspirin', '$2a$11$4wXmhyZHOM8MJamwV6yVAeF5a2Q');
/*passwords: qwertyqwerty*/

insert into Role(name) values ('client'),('barber'),('admin');
